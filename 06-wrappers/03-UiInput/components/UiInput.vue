<template>
  ...
  >
    <div v-if="$slots['left-icon']" class="input-group__icon">
      <slot name="left-icon" class="input-group_icon" :class="{ 'input-group_icon-left': $slots['left-icon'] }" />
    </div>
    ...
    <div v-if="$slots['right-icon']" class="input-group__icon">
      <slot name="right-icon" class="input-group_icon" :class="{ 'input-group_icon-right': $slots['right-icon'] }" />
    </div>
  </div>
</template>
